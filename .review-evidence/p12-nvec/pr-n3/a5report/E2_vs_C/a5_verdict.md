...
- Reference dir: `/scratch/frd_muziyao/SHUD-OpenMP/.p12-nvec-runs/a5pair/C.out`
- Candidate dir: `/scratch/frd_muziyao/SHUD-OpenMP/.p12-nvec-runs/a5pair/E2.out`
...
| kge | 0.999881 | min=0.99 | 1.00 | PASS |  |
| peak_magnitude_ratio | 1.00016 | min=0.9, max=1.1 | 0.75 | PASS |  |
| peak_timing_offset | 0 | max_abs_steps=1 | 0.50 | PASS |  |
| runoff_volume_ratio | 0.999912 | min=0.99, max=1.01 | 1.00 | PASS |  |
| monthly_bias_mae | 0.000109311 | max=0.05 | 0.50 | PASS |  |
